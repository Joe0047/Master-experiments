...
while(turn > 0):
    ...
    executionTimeOfCLS = end - start
    
    print("========================================================")
    print('execution time of CLS: %f' % executionTimeOfCLS)
    print("========================================================")
    
    listOfTurnsCLS.append(executionTimeOfCLS)
...
plt.bar(x[1],CLS,width,color = 'r', label="CLS")
